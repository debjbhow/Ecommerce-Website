...
<body style="background-color:lightgray" onload="totalprice()" >
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +91 1800410004</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i>shop@redstore.in</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="img/logo.png" alt="" /></a>
            </div> 
          </div>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span></span>REDSTORE</h2>
              <p>Reacraeting Fashion & Brands</p>
            </div>
          </div>
          <div class="col-sm-7">
            <div class="col-sm-6">
              <div class="video-gallery text-center">
                <a href="#"> 
                    ...
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/UwcaZ0wcGuo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>                </a>               </div>
            </div>
