      ...
      <div class="row">
         <div class="row">
              ...
              <div class="form-group">
                  ...
                  <div class="radio" >
                      <label >
                      <p>Customer can use following Payment Method:</p>
                      <ol>
...
<br/>
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                      ...
                      <button type="submit" class="btn btn-pup  pull-right " name="btn" id="btn" onclick="return validatedate();"   /> Cash On Delivery <span class="glyphicon glyphicon-chevron-right"></span></button></br> 
 ...
 <button   name="btn1" id="btn" onclick="window.location.href='http://localhost/ecommerce/checkout.php';" style="margin-left: 85%; padding :0.5%; border:none; margin-bottom :3%; border-radius:3px;"/> Online Payment<span class="glyphicon glyphicon-chevron-right"></span></button>
